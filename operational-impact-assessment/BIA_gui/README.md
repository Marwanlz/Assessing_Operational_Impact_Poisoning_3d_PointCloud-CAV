...
Graphical interface interacting the API to compute impact and asset criticality.
...
- Add a new Node: Shift+Click on empty space.
- Add a new Edge: Shift+Click on a node, hold shift and drag to another node.
- Edit a Node: Ctrl+Click on a node.
- Edit a Edge: Ctrl+Clik on a Edge.
...
The source code is a fork of another project Mindcraft, fork from the project directed-graph-creator, both under the same license.
Fork: https://github.com/eldipa/Mindcraft
...
Taken source from the Mindcraft project, these are their respective licenses:
